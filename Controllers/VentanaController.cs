...
namespace ExpediFlow.Controllers
{
    public class VentanaController : Controller
    {
        ...
        public VentanaController(DBContext context, UserManager<Usuario> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(int pg, string filter)
        {
            ...
            if (filter != null)
            {
                registros = await _context.Ventanas.Where(r => r.Nombre.ToLower().Contains(filter.ToLower())).ToListAsync();
            }
            else
            {
                registros = await _context.Ventanas.ToListAsync();
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ventana = await _context.Ventanas
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ventana = await _context.Ventanas.FindAsync(id);
            if (ventana == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            try
            {
                ...
                if (ventana != null)
                {
                    _context.Ventanas.Remove(ventana);
                    await _context.SaveChangesAsync();
        ...
        {
            return _context.Ventanas.Any(e => e.Id == id);
        }
